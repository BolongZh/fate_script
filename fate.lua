...
{
    {
    ...
    },
     {
        ...
        shopItems = {
            ...
            { itemName = "Wind-up Dryad Minion", itemIndex = 6, price = 500 },
            { itemName = "Rarefied Night Pepper Seeds", itemIndex = 9, price = 100 },
            { itemName = "Sprawling Nova Roader Horn", itemIndex = 12, price = 600 },
            { itemName = "Rustic Villa Walls", itemIndex = 18, price = 30 },
            { itemName = "Love Triangle", itemIndex = 20, price = 10 },
        }
    },
    {
...
ShouldExtractMateria           = false       --should it Extract Materia
